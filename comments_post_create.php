...
if (
    ...
    !isset($postData['team_lfl_id']) ||
    !is_numeric($postData['team_lfl_id']) ||
...
$team_lflId = (int)$postData['team_lfl_id'];
...
$insertTeam_lfl = $mysqlClient->prepare('INSERT INTO comments(comment, team_lfl_id, user_id, review) VALUES (:comment, :team_lfl_id, :user_id, :review)');
$insertTeam_lfl->execute([
    'comment' => $comment,
    'team_lfl_id' => $team_lflId,
